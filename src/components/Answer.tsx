...
const Answer = ({ data, loading, handleSave, handleNext }: LoaderProps) => (
  <>
    {loading ? (
      <div className="mt-4">
      ...
      <div className="mt-4">
        <p className="h-auto bg-gray-100 border border-solid border-gray-200 rounded-2xl p-2 text-left tracking-wide leading-8">
          {data}
        </p>
